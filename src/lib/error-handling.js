...
export const getError = (error) => {
  const errors = {
    ...
    INVALID_API_URL:
      "Invalid URL. Ensure your Ghost URL is correct and try again.",
    ...
    NO_PERMISSION:
      "Permission not granted. Submit your settings again to confirm permissions.",
    SITE_OFFLINE:
      "Your Ghost site is currently offline. Contact support@ghost.org for help.",
    MAINTENANCE:
      "Your Ghost site is currently in maintenance mode. Try again later.",
    DOMAIN_ERROR:
      "Your custom domain is invalid. Contact support@ghost.org for help.",
    FAILED_REQUEST:
      "Failed to fetch. Ensure your URL is correct and try again.",
    NO_LEXICAL:
      'Unable to save. If you already have a draft post called "Bookmarked links", rename it and try again',
  };
...
export function sendMessageToPopup(content) {
  ...
  browser.runtime.sendMessage({ type, text, uuid });
}
